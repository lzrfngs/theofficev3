...
Review is the revision workspace for rounds of changes after a final artifact exists. Users can attach notes to individual deliverable sections, assign specialists, request a targeted revision without rerunning the whole team, compare revision candidates, accept or reject them, and patch accepted revisions back into the latest Output artifact. Review notes and candidates persist locally and travel with workspace export/import.
